...
public class VideoEndpoint {
	...
	public Response uploadVideo(@FormDataParam("file") InputStream fileInputStream,
			...
			@Context HttpHeaders httpheaders, @Context UriInfo uriInfo) throws Exception {
	...
	private boolean authenticate(String userid, String url, String date, String authToken) {
		if (userid.isEmpty() || url.isEmpty() || date.isEmpty() || authToken.isEmpty() || userid.isBlank()
